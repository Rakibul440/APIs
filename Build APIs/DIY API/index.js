...
app.get("/filter",(req,res)=>{
  ...
  const type = req.query.type // "type" is documented of this API for query
...
app.put("/jokes/:id",(req,res)=>{
  ...
  jokes[findJokeIndex] = replaceJoke
...
app.delete("/all",(req,res)=>{
  ...
  if(userKey === masterKey){
    ...
    res
    .status(404)
    .json({error : `You are not authorised to do this action`})
  }
})
app.listen(port, () => {
